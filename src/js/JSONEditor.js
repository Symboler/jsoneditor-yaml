...
function JSONEditor (container, options, json) {
  ...
  // check yaml
  if (options.inYaml === true) {
    // if (typeof window.YAML === 'undefined') {
    //   throw new Error('JSONEditer code in YAML requires YAML')
    // }
    if (typeof ace.define.modules['ace/mode/yaml'] === 'undefined') {
      throw new Error('JSONEditer code in YAML requires ace/mode/yaml')
    }
  }
