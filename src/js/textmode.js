...
textmode.create = function (container, options) {
  ...
  !this.options.inYaml && this.menu.appendChild(buttonFormat);
  ...
  !this.options.inYaml && this.menu.appendChild(buttonCompact);
...
textmode.set = function(json) {
  ...
  if (!this.options.inYaml) {
    ...
    this.setText(YAML.stringify(json, null, this.indentation));
  }
};
...
textmode.get = function() {
  ...
  var json;
  if (this.options.inYaml) {
    return YAML.parse(text||"null"); // this can throw an error
  }
  try {
...
textmode.setText = function(jsonText) {
  ...
  if (this.options.inYaml) {
    if (text == '{}') {
      ...
      text = YAML.stringify(JSON.parse(text), this.options.yamlDepth || 20, 2)
    }
  }
